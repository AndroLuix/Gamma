...
public class ScritturaFile {
    public static void main(String[] args) {
        ...
        try {
            ...
            file_scrittura.write("1 - Questa è una prova di scrittura di file.");
...
// File scritto in overwrite + metodo append
            FileWriter file_scrittura = new FileWriter(new File("C:\\temp\\fileprovascrittura.txt"));
            file_scrittura.write("2 - Questa è una prova di scrittura di file.");
...
/********************************************************************
// Terza modalità
// File scritto in overwrite + metodo append + a capo
